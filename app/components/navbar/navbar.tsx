...
export default function Navbar({activeLink, updateActiveLink}: Props) {
    ...
    return (
        ...
        <header id="cs-navigation">
            <div className="cs-container">
                {/*Nav Logo*/}
                <Link href="/" className="cs-logo" aria-label="back to home" onClick={() => updateActiveLink(LinkName.Home)}>
                    <Image
                ...
                <nav className="cs-nav" role="navigation">
                    ...
                    <div className="cs-ul-wrapper">
                        <ul id="cs-expanded" className="cs-ul" aria-expanded="false">
                            <li className="cs-li">
                                <Link href="/" onClick={() => updateActiveLink(LinkName.Home)} className={activeLink === LinkName.Home ? "cs-li-link cs-active" : "cs-li-link"}>
                                    Home
                                </Link>
                            </li>
                            <li className="cs-li">
                                <Link href="/why-choose-us" onClick={() => updateActiveLink(LinkName.WhyChooseUs)} className={activeLink === LinkName.WhyChooseUs ? "cs-li-link cs-active" : "cs-li-link"}>
                                    Why Choose Us
                                </Link>
                            </li>
                            <li className="cs-li">
                                <Link href="/blog/" onClick={() => updateActiveLink(LinkName.Blog)} className={activeLink === LinkName.Blog ? "cs-li-link cs-active" : "cs-li-link"}>
                                    Blog
                                </Link>
                            </li>
                            <li className="cs-li">
                                <Link href="exam" onClick={() => updateActiveLink(LinkName.Exam)} className={activeLink === LinkName.Exam ? "cs-li-link cs-active" : "cs-li-link"}>
                                    The Exam
                                </Link>
                            </li>
                        </ul>
                ...
                <Link id='navContactUs' href="/#contact-1388" onClick={() => updateActiveLink(LinkName.Home)} className="cs-button-solid cs-nav-button">Contact Us</Link>
