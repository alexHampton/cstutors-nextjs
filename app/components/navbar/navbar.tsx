                ...
                <nav className="cs-nav" role="navigation">
                    ...
                    <div className="cs-ul-wrapper">
                        <ul id="cs-expanded" className="cs-ul" aria-expanded="false">
                            <li className="cs-li">
                                <Link href="/" className={clsx("cs-li-link", {"cs-active" : pathname === "/"})}>
                                    Home
                                </Link>
                            </li>
                            <li className="cs-li">
                                <Link href="/why-choose-us" className={clsx("cs-li-link", { "cs-active": pathname === "/why-choose-us" })}>
                                    Why Choose Us
                                </Link>
                            </li>
                            <li className="cs-li">
                                <Link href="/blog/" className={clsx("cs-li-link", { "cs-active": pathname === "/blog" })}>
                                    Blog
                                </Link>
                            </li>
                            <li className="cs-li">
                                <Link href="exam" className={clsx("cs-li-link", { "cs-active": pathname === "/exam" })}>
                                    The Exam
                                </Link>
                            </li>
                        </ul>
